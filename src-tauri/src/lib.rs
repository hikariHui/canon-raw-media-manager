...
#[tauri::command]
fn read_directory_files(dir_path: String) -> Result<Vec<String>, String> {
    // 检查路径是否为空
...
#[tauri::command]
fn is_file_exists(file_path: String) -> Result<bool, String> {
...
#[tauri::command]
fn list_watching_directories(watcher_manager: State<WatcherManager>) -> Vec<String> {
    let watchers = watcher_manager.watchers.lock().unwrap();
